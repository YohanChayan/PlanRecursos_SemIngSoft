<x-app-layout>
    ...
    @if(isset($project))
      <form action="{{ route ('chiefR.projects.update',$project)}}" method="POST" class="flex flex-col w-full p-10 px-8 pt-6 mx-auto my-6 mb-4 transition duration-500 ease-in-out transform bg-white border rounded-lg lg:w-1/2 ">
      @method('PATCH')
    @else
